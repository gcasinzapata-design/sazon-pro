...
function StrategyIcon(){ return (
  <svg viewBox="0 0 24 24" className="h-10 w-10 text-primary"><path fill="currentColor" d="M3 3h2v2H3zm16 0h2v2h-2zM3 19h2v2H3zm16 0h2v2h-2zM7 5h10v2H7zm0 12h10v2H7zM6 9h2v6H6zm10 0h2v6h-2z"/></svg>
)}

function MegaphoneIcon(){ return (
  <svg viewBox="0 0 24 24" className="h-10 w-10 text-primary"><path fill="currentColor" d="M3 10v4a2 2 0 0 0 2 2h1l5 3v-14l-5 3H5a2 2 0 0 0-2 2zm13-3v10l5 3V4z"/></svg>
)}

function BrandingIcon(){ return (
  <svg viewBox="0 0 24 24" className="h-10 w-10 text-primary"><path fill="currentColor" d="M4 4h16v6H4zM4 14h7v6H4zm9 0h7v6h-7z"/></svg>
)}

function AIDevIcon(){ return (
  <svg viewBox="0 0 24 24" className="h-10 w-10 text-primary"><path fill="currentColor" d="M12 2l4 4-4 4-4-4 4-4zm-8 8l4 4-4 4-4-4 4-4zm16 0l4 4-4 4-4-4 4-4zM12 14l4 4-4 4-4-4 4-4z"/></svg>
)}
